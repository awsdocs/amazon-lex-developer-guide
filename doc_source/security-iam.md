...
**IAM administrator** – If you're an IAM administrator, you might want to learn details about how you can write policies to manage access to Amazon Lex\. To view example Amazon Lex identity\-based policies that you can use in IAM, see [Amazon Lex Identity\-Based Policy Examples](security_iam_id-based-policy-examples.md)\.
