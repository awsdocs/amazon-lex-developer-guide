# Troubleshooting Amazon Lex Identity and Access<a name="security_iam_troubleshoot"></a>
...
**Topics**
+ [I Am Not Authorized to Perform an Action in Amazon Lex](#security_iam_troubleshoot-no-permissions)
+ [I Am Not Authorized to Perform iam:PassRole](#security_iam_troubleshoot-passrole)
+ [I Want to View My Access Keys](#security_iam_troubleshoot-access-keys)
+ [I'm an Administrator and Want to Allow Others to Access Amazon Lex](#security_iam_troubleshoot-admin-delegate)
+ [I Want to Allow People Outside of My AWS Account to Access My Amazon Lex Resources](#security_iam_troubleshoot-cross-account-access)

## I Am Not Authorized to Perform an Action in Amazon Lex<a name="security_iam_troubleshoot-no-permissions"></a>
...
## I'm an Administrator and Want to Allow Others to Access Amazon Lex<a name="security_iam_troubleshoot-admin-delegate"></a>
...
## I Want to Allow People Outside of My AWS Account to Access My Amazon Lex Resources<a name="security_iam_troubleshoot-cross-account-access"></a>
